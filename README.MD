...
Chrome. So, it will probably still work OK in firefox, but the pieces will probably be off as .width and .height will include
or not include its margin and/or padding sizes dependant on browser.
